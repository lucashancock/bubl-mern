  ...
  return (
    ...
    <div className="container w-1/2 min-w-max border border-gray-300 rounded-md p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
        <form className="space-y-6">
          ...
          <div className="!mt-10">
            <button type="button" className="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded text-white bg-[#333] hover:bg-black focus:outline-none" onClick={handleRegister}>
              register
            </button>
          </div>
          <p className="text-sm !mt-10 text-center">have an account? <a href="/login" className="text-blue-600 hover:underline ml-1 whitespace-nowrap">log in here</a></p>
        </form>
      </div>
      </div>
